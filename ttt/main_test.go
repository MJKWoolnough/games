...
func TestResultsEncode(t *testing.T) {
	for n, test := range [...]Results{
		Results(0).Set(0, WillLose).Set(1, DrawOdd).Set(2, DrawEven).Set(3, WillWin).Set(4, FilledX).Set(5, FilledO).Set(6, WillLose).Set(7, DrawOdd).Set(8, DrawEven),
		Results(0).Set(0, DrawOdd).Set(1, DrawEven).Set(2, WillWin).Set(3, FilledX).Set(4, FilledO).Set(5, WillLose).Set(6, DrawOdd).Set(7, DrawEven).Set(8, WillWin),
		Results(0).Set(0, DrawEven).Set(1, WillWin).Set(2, FilledX).Set(3, FilledO).Set(4, WillLose).Set(5, DrawOdd).Set(6, DrawEven).Set(7, WillWin).Set(8, FilledX),
		Results(0).Set(0, WillWin).Set(1, FilledX).Set(2, FilledO).Set(3, WillLose).Set(4, DrawOdd).Set(5, DrawEven).Set(6, WillWin).Set(7, FilledX).Set(8, FilledO),
		Results(0).Set(0, FilledX).Set(1, FilledO).Set(2, WillLose).Set(3, DrawOdd).Set(4, DrawEven).Set(5, WillWin).Set(6, FilledX).Set(7, FilledO).Set(8, WillLose),
		Results(0).Set(0, FilledO).Set(1, WillLose).Set(2, DrawOdd).Set(3, DrawEven).Set(4, WillWin).Set(5, FilledX).Set(6, FilledO).Set(7, WillLose).Set(8, DrawOdd),
	} {
		re := test.Encode()
...
func TestBrainGetResults(t *testing.T) {
	...
	for n, test := range [...]struct {
		...
		},
		{
			...
			Results(0).Set(0, FilledX).Set(1, FilledO).Set(2, FilledO).Set(3, WillWin).Set(4, DrawEven).Set(5, WillWin).Set(6, WillWin).Set(7, FilledX).Set(8, WillWin).SetState(WillWin),
		},
	} {
